...
/*
 * Problem Statement: Given the head of a LinkedList and two positions ‘p’ and ‘q’, reverse the
 * LinkedList from position ‘p’ to ‘q’.
 */
public class ReverseSubList {
    public static ListNode reverseBF(ListNode head, int p, int q) {
        ListNode begin = head;
        ListNode end;
        ListNode curr;
        ListNode prev;
    ...
    public static void bruteForce() {
        ...
        ListNode result = ReverseSubList.reverseBF(head, 2, 4);
